				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="/FanHeo/index.php/Admin/User/../Login/loginout"><i class="icon-key"></i> Log Out</a></li>
			...
			<div class="container-fluid">
				...
				<tr>
					...
					<?php if(is_array($user)): foreach($user as $key=>$v): ?><tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#FFF5EE';">
							...
							<td><img src="<?php echo ($v["head_ico"]); ?>" id="imgs" lang="en-us" alt="测试" style="height:50px;weight:50px;"></img></td>
