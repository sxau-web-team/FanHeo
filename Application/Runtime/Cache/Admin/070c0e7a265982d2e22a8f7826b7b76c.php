		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							管理组角色列表 <small>今日任务：统计在售商户商品的库存</small>
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">管理角色列表</a></li>
							
							<li style="float:right;padding-right:20px;"><a href="<?php echo U('Admin/Rbac/addRole');?>">添加管理组角色</a></li>
				...
				<tr>
					...
					<?php if(is_array($role)): foreach($role as $key=>$v): ?><tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#FFF5EE';">
