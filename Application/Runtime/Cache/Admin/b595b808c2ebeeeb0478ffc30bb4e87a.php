				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="/FanHeo/index.php/Admin/Index/../Login/loginout"><i class="icon-key"></i> Log Out</a></li>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							仪表盘<small>		今日任务：统计在售商户的库存</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
					...
					<div class="row-fluid">						<div class="span3 responsive" data-tablet="span6" data-desktop="span3">							<div class="dashboard-stat green">								<div class="visual">									<i class="icon-shopping-cart"></i>								</div>								<div class="details">									<div class="number">35</div>									<div class="desc">新订单</div>								</div>								<a class="more" href="#">								查看更多订单 <i class="m-icon-swapright m-icon-white"></i>								</a>                 							</div>						</div>
						<div class="span3 responsive" data-tablet="span6" data-desktop="span3">
							<div class="dashboard-stat blue">
								...
								<a class="more" href="#">
								查看更多建议 <i class="m-icon-swapright m-icon-white"></i>
								</a>                 
							</div>
						</div>
						<div class="span3 responsive" data-tablet="span6  fix-offset" data-desktop="span3">							<div class="dashboard-stat yellow">								<div class="visual">									<i class="icon-bar-chart"></i>								</div>								<div class="details">									<div class="number">￥43,434</div>									<div class="desc">总利润</div>								</div>								<a class="more" href="#">								查看更多销售统计 <i class="m-icon-swapright m-icon-white"></i>								</a>                 							</div>						</div>
						<div class="span3 responsive" data-tablet="span6  " data-desktop="span3">
							<div class="dashboard-stat purple">
								...
								<div class="details">
									...
									<div class="desc">商户销售增长率</div>
								</div>
								<a class="more" href="#">
								查看更多商户 <i class="m-icon-swapright m-icon-white"></i>
								</a>                 
							</div>
						</div>
						...
						<div class="span6">
							...
							<div class="portlet solid bordered light-grey">
								<div class="portlet-title">
									<div class="caption"><i class="icon-bar-chart"></i>网站访问统计</div>
									<div class="tools">
							...
							<div class="portlet solid light-grey bordered">
								...
								<div class="portlet-body">
									<div id="site_activities_loading">
										<img src="/FanHeo/Public/media/image/loading.gif" alt="loading" />
									</div>
									...
									<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
										<ul class="chats">
											<li class="in">
												...
												<div class="message">
													<span class="arrow"></span>
													<a href="#" class="name"><?php echo ($loginname); ?></a>
