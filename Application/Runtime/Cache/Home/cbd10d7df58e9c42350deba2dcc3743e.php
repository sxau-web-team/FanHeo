  ...
  <div class="panel-body">
    ...
    <form class="form-horizontal" role="form">
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="user" class="form-control" id="inputEmail3" placeholder="Email" required autofocus>
            </div>
          </div>
          <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-4">
              <div class="checkbox">
                <label>
                  <input type="checkbox"> 我同意FanHeo.饭盒有关条款
                </label>
              </div>
            </div>
            </div>
...
<div class="alert alert-success alert-dismissable">
  ...
  <strong>Warning!</strong> Best check yo self, you're not looking too good.<a href="#" class="alert-link">...</a>
</div>
