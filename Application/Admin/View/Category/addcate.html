	...
	<include file="Public/include/Admin_sidebar.html"/>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							添加商品管理分类 <small>今日任务：统计在售商户商品的库存</small>
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="{:U('Admin/Rbac/index')}">商品管理</a>

								<i class="icon-angle-right"></i>

							</li>

							<li><a href="#">添加管理分类</a></li>
				...
				<form action="{:U('Category/runAddCate','','')}" method="post" class="form-horizontal" charset='utf-8'>
					...
					<!-- <div class="control-group">
						...
						<label class="control-label">* 角色名称：</label>
							...
							<div class="controls">
								...
								<input type="text" placeholder="请输入要添加的角色" class="m-wrap medium" name="name"/>
					...
					<div class="control-group">
						...
						<label class="control-label">* 角色描述：</label>
							...
							<div class="controls">
								...
								<input type="text" placeholder="请输入关于该角色的描述" class="m-wrap medium" name="remark"/>
...
<!-- <form method="post" action="{:U('Category/runAddCate','','')}">
<table class='table'>
	<tr>
		<th colspan="2">添加栏目分类</th>
	</tr>
