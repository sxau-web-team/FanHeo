	...
	<include file="Public/include/Admin_sidebar.html"/>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							添加品牌 <small>今日任务：统计在售商户商品的库存</small>
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="{:U('Admin/Good/index')}">产品管理</a>
				...
				<form action="{:U('Admin/brand/addbrandHandler')}" method="post" class="form-horizontal" charset='utf-8'>
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<select class="medium m-wrap" tabindex="1" name="sort">

								<option value="">请选择分类</option>
	
								<foreach name='category' item='v'>
							
								<option value="{$v['id']}">{$v.name}({$v.pid})</option>
					...
					<div class="control-group">
						...
						<label class="control-label">* 品牌标题：</label>
					...
					<div class="control-group">
						...
						<label class="control-label">* 品牌详细情况：</label>

							<div class="controls">

								<input type="text" placeholder="" class="m-wrap medium" name="content"/>
					...
					<div class="control-group">
						...
						<label class="control-label">* 品牌关键字：</label>

							<div class="controls">

								<input type="text" placeholder="" class="m-wrap medium" name="keywords"/>
					...
					<div class="control-group">
						...
						<label class="control-label">* 品牌描述：</label>
							...
							<div class="controls">
								...
								<input type="text" placeholder="" class="m-wrap medium" name="description"/>
					...
					<div class="control-group">
						...
						<label class="control-label">* 品牌缩略图地址：</label>

							<div class="controls">

								<input type="text" placeholder="" class="m-wrap medium" name="imgurl"/>
